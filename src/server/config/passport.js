      ...
      process.nextTick(function() {
        ...
        User.findOne({ 'email' :  email }, function(err, user) {
            ...
            if (user) {
                ...
                //TODO controllare i campi, ovviamente non saranno solo questi...
                ...
                newUser.cellulare = req.body.cellulare;
                newUser.gender = req.body.gender;
                newUser.image = null;
                newUser.city = req.body.city;
                newUser.tipo = req.body.tipo;
                newUser.skills = [];
                newUser.descrizione = req.body.descrizione;
                newUser.annunci = [];

                prepareslug = newUser.firstname + '' + newUser.lastname + '' + newUser.city;
                newUser.slug = prepareslug.replace(/\s+/g, '');
                // save the user
